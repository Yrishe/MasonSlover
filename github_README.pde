...
void setup() {
  ...
  strs[0][0] = "Hey there!";
  strs[0][1] = "My name is Yarli Rabelo.";

  strs[1][0] = "I'm a Metrology Engineer and Computer Science student.";
  strs[1][1] = "at University of London.";

  strs[2][0] = "I've been teaching myself how to code for 5 years!";
  strs[2][1] = "I am fluent in C++, Python, JavaScript, and HTML & CSS.";

  strs[3][0] = "I've created apps, websites, art and measurement solutions.";
  strs[3][1] = "with what I have learned from my bachelor Degree";

  strs[5][0] = "Feel free to reach out to say hi!";
  strs[5][1] = "email: yurcreative@gmail.com";
}
